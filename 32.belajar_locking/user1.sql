...
UPDATE questbooks SET title = "Diubah Oleh User 1" WHERE id = 9 ;
...
-- Todo Read(Hanya bisa melakukan read terhadap tabel tersebut dan untuk di proses lain Hanya bisa melakukan read terhadap tabel tersebut, tidak bisa melakukan write)
...
UPDATE products SET quantity = 10 WHERE id = "P0001";
